...
<template>
    <div>
        ...
        <Dialog :visible="isDialogVisible" :breakpoints="{ '1199px': '75vw', '575px': '90vw' }" maximizable
            header="Create Category" :modal="true" :closable="false" :style="{ width: '50vw' }">
                ...
                <div class="grid grid-cols-12 gap-6">
                    <div class="col-span-7">
                        ...
                        <div class="flex flex-col mt-2 gap-1">
                            ...
                            <textarea v-model="description" placeholder="Enter Category Description"
            ...
            <template #footer>
                <div class="w-full flex flex-row items-center justify-between">
                    ...
                    <button @click="submitForm" class="py-2 flex items-center gap-2 px-3 bg-slate-500 text-white rounded-md" type="button">
