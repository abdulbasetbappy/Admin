  ...
  <div class="container mx-auto p-4">
    ...
    <div class="flex justify-between mb-2">
      ...
      <div>
        ...
        <div class="relative inline-block text-left">
          <div>
            <label class="mr-2 font-medium">Categories Per Page:</label>
            <button
              type="button"
      ...
      <table class="min-w-full bg-transparent rounded-sm">
        ...
        <thead class="bg-slate-300 dark:bg-slate-700">
          <tr>
            ...
            <th class="py-2 px-4 text-left">Sub Category</th>
        ...
        <tbody>
          ...
          <!--Serial Number-->
            ...
            <td class="py-2 px-4 text-sm text-left">
              Pant, Shirt, Skirt, Mart, fart dart, jwellary, kurti, murti, Jaja
            </td>
            <!-- Total Product-->
