...
<template>
    <div>
        ...
        <Dialog :visible = "isDialogVisible" :breakpoints="{ '1199px': '75vw', '575px': '90vw' }" maximizable
            header="Create Brand" :modal="true" :closable="false" :style="{ width: '50vw' }">
            ...
            <template #footer>
                <div class="w-full flex flex-row items-center justify-between">
                    <button @click="isDialogVisible = false" class="py-2 px-3 bg-rose-500 text-white rounded-md"
                        type="button">
                        Cancel
                        <Icon name="material-symbols:cancel-outline-rounded" />
                    </button>
                    <button @click="submitForm" class="py-2 px-3 bg-slate-500 text-white rounded-md" type="button">
